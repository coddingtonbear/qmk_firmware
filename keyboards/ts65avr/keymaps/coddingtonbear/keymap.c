...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNC] = KEYMAP( \
        ...
        RESET,   _______, _______, _______, _______, TG_GAME,          KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, _______, _______, KC_VOLD, \
    ...
    [_GAME] = KEYMAP( \
        ...
        _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______,\
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, \
        _______, _______, _______, KC_SPC,  _______,                   _______,          KC_LGUI, _______, _______, _______,          _______, _______),
