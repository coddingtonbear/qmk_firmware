...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = KEYMAP( \
        ...
        KC_LCTL, MO_FUNC, KC_LALT, KC_LGUI,  KC_SPC,                   KC_SPC,           KC_RGUI, MO_MSE,  KC_RCTL, KC_LEFT,          KC_DOWN, KC_RIGHT),
    ...
    [_MOUSE] = KEYMAP( \
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, \
        _______, _______, _______, KC_BTN2, KC_BTN1,                   KC_BTN1,          KC_BTN2, _______, _______, _______,          _______, _______),
